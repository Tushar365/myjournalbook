...
const DARE_LEVELS: Record<string, DareLevel> = {
  easy: {
    ...
    dares: [
      ...
      "Which sounds more fun: pillow fight, water fight, or staring contest?",
      "If you could plan our dream hangout day, what would it be?",
  ...
  hard: {
    ...
    dares: [
      ...
      "What's your biggest turn-on in a relationship?",
      "Have you ever had a dream about me? Be honest.",
      ...
      "Rate our chemistry from 1-10 and explain why.",
      "What would you do if I confessed feelings for you right now?",
